...
CREATE TABLE "new_folhas_previdenciarias" (
    ...
    "diferenca_aprovada" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_folhas_previdenciarias" ("acrescimo", "acrescimo_tipo", "aliquota", "competenciaId", "createdAt", "dataVencimento", "deficit", "encargosTotal", "exercicioId", "folhaBase", "id", "inadimplencia", "juros", "multas", "observacoes", "orgaoId", "parcelado", "percentualPago", "quantidadeServidores", "responsavelId", "status", "superavit", "tipo", "updatedAt", "valorLiquidoArrecadado", "valorRecolher", "valorRecolherCalculado", "valorRecolhido", "valorTotalDevido") SELECT "acrescimo", "acrescimo_tipo", "aliquota", "competenciaId", "createdAt", "dataVencimento", "deficit", "encargosTotal", "exercicioId", "folhaBase", "id", "inadimplencia", "juros", "multas", "observacoes", "orgaoId", "parcelado", "percentualPago", "quantidadeServidores", "responsavelId", "status", "superavit", "tipo", "updatedAt", "valorLiquidoArrecadado", "valorRecolher", "valorRecolherCalculado", "valorRecolhido", "valorTotalDevido" FROM "folhas_previdenciarias";
